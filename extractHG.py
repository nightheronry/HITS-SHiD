...
class extractHG():
    ...
    def timeModify(self, timelist=[], merged_bool=0):
        modetimeList = []
...
if __name__ == '__main__':
    ...
    ex.timeModify([[53, 54], [75], [23], [83], [165]], 1)
    ex.extractAnnotaton(0, 'HITS')

    ex.timeModify([[53], [23], [165], [75], [54], [18], [83], [74], [17], [13], [46], [11], [22], [37], [137]])
    ex.extractAnnotaton(0, 'MT')
    ex.timeModify([[53, 54], [22, 23], [165], [74, 75], [18], [83], [17], [13], [46], [11], [37], [137]], 1)
    ex.extractAnnotaton(0, 'MT')
    ...
    ex.extractAnnotaton(0, 'MT')
    ex.timeModify([[58, 59], [62, 63], [184], [126], [48, 49, 50, 51], [54, 55], [135], [19], [182]], 1)
    ex.extractAnnotaton(0, 'MT')
    ...
    ex.extractAnnotaton(0, 'HITS')
    ex.timeModify([[68, 69, 70, 71, 72], [75, 76], [141], [131, 132], [152], [57]], 1)
    ex.extractAnnotaton(0, 'HITS')

    ex.timeModify([[71], [70], [72], [75], [69], [57], [76], [68], [141], [56], [73], [131], [58], [152], [142]])
    ex.extractAnnotaton(0, 'MT')
    ex.timeModify([[68, 69, 70, 71, 72, 73], [75, 76], [56, 57, 58], [141, 142], [131], [152]], 1)
    ...
    ex.extractAnnotaton(0, 'HITS')
    ex.timeModify([[133], [198, 199], [130], [195, 196], [146], [183], [149], [201], [137], [189]], 1)

    ex.extractAnnotaton(0, 'HITS')

    ex.timeModify([[133], [198], [199], [130], [195], [201], [134], [200], [196], [190], [146], [149], [51], [189], [153]])
    ex.extractAnnotaton(0, 'MT')
    ex.timeModify([[133], [198, 199, 200], [130], [195, 196], [134], [189, 190], [146], [149], [51], [153]], 1)
    ...
    ex.extractAnnotaton(0, 'HITS')
    ex.timeModify([[157, 158], [64, 65], [50, 51], [85, 86], [161], [89]], 1)

    ex.extractAnnotaton(0, 'HITS')

    ex.timeModify([[64], [65], [50], [157], [51], [86], [85], [135], [158], [89], [161], [136], [52], [66], [162]])
    ex.extractAnnotaton(0, 'MT')
    ex.timeModify([[64, 65, 66], [50, 51, 52], [157, 158], [85, 86], [135], [89], [161, 162], [136]], 1)
    ...
    ex.extractAnnotaton(0, 'HITS')
    ex.timeModify([[62, 63, 64], [177, 178, 179], [174, 175], [188, 189], [80], [109, 110], [140]], 1)

    ex.extractAnnotaton(0, 'HITS')

    ex.timeModify([[63], [178], [174], [179], [189], [62], [54], [64], [80], [188], [53], [110], [109], [177], [159]])
    ex.extractAnnotaton(0, 'MT')
    ex.timeModify([[62, 63, 64], [177, 178, 179], [174], [188, 189], [53, 54], [80], [109, 110], [159]], 1)
